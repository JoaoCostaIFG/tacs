...
import cv.identification.contact.Contact;
...
/**
 * This is the item provider adapter for a {@link cv.identification.contact.Contact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContactItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContactPackage.Literals.CONTACT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInfoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contact_info_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contact_info_feature", "_UI_Contact_type"),
				 ContactPackage.Literals.CONTACT__INFO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Contact.class)) {
			case ContactPackage.CONTACT__NAME:
			case ContactPackage.CONTACT__INFO:
