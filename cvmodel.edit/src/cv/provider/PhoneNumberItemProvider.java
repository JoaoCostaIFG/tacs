...
/**
 * This is the item provider adapter for a {@link cv.PhoneNumber} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PhoneNumberItemProvider extends ContactItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CvPackage.Literals.PHONE_NUMBER__COUNTRY_CODE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PhoneNumber.class)) {
			case CvPackage.PHONE_NUMBER__COUNTRY_CODE:
