...
/**
 * This is the item provider adapter for a {@link cv.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CvPackage.Literals.FILE__CREATED_DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(File.class)) {
			case CvPackage.FILE__PATH:
			case CvPackage.FILE__TYPE:
			case CvPackage.FILE__CREATED_DATE:
