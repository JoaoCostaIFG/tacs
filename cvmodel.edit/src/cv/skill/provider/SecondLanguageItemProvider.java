...
import cv.skill.SecondLanguage;
...
/**
 * This is the item provider adapter for a {@link cv.skill.SecondLanguage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecondLanguageItemProvider extends LanguageItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SkillPackage.Literals.SECOND_LANGUAGE__CONVERSATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SkillPackage.Literals.SECOND_LANGUAGE__READING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SkillPackage.Literals.SECOND_LANGUAGE__WRITING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SkillPackage.Literals.SECOND_LANGUAGE__COMPREHENSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SkillPackage.Literals.SECOND_LANGUAGE__PEER_REVIEW,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SecondLanguage.class)) {
			case SkillPackage.SECOND_LANGUAGE__CONVERSATION:
			case SkillPackage.SECOND_LANGUAGE__READING:
			case SkillPackage.SECOND_LANGUAGE__WRITING:
			case SkillPackage.SECOND_LANGUAGE__COMPREHENSION:
			case SkillPackage.SECOND_LANGUAGE__PEER_REVIEW:
