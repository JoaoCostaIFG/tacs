...
/**
 * This is the item provider adapter for a {@link cv.edutrain.EducationTraining} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EducationTrainingItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdutrainPackage.Literals.EDUCATION_TRAINING__TITLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdutrainPackage.Literals.EDUCATION_TRAINING__ORGANIZATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdutrainPackage.Literals.EDUCATION_TRAINING__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdutrainPackage.Literals.EDUCATION_TRAINING__FINAL_GRADE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdutrainPackage.Literals.EDUCATION_TRAINING__FIELDS_OF_STUDY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdutrainPackage.Literals.EDUCATION_TRAINING__EQF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EducationTraining.class)) {
			case EdutrainPackage.EDUCATION_TRAINING__TITLE:
			case EdutrainPackage.EDUCATION_TRAINING__ORGANIZATION:
			case EdutrainPackage.EDUCATION_TRAINING__DESCRIPTION:
			case EdutrainPackage.EDUCATION_TRAINING__FINAL_GRADE:
			case EdutrainPackage.EDUCATION_TRAINING__FIELDS_OF_STUDY:
			case EdutrainPackage.EDUCATION_TRAINING__EQF:
