...
/**
 * This is the item provider adapter for a {@link cv.content.TimeFrame} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeFrameItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContentPackage.Literals.TIME_FRAME__START_DATE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Date labelValue = ((TimeFrame)object).getStartDate();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TimeFrame.class)) {
			case ContentPackage.TIME_FRAME__START_DATE:
