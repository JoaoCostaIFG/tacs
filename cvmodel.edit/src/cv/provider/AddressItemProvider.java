...
/**
 * This is the item provider adapter for a {@link cv.Address} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddressItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Address_line1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Address_line1_feature", "_UI_Address_type"),
				 CvPackage.Literals.ADDRESS__LINE1,
				 true,
				 false,
				 false,
	...
	protected void addLine2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Address_line2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Address_line2_feature", "_UI_Address_type"),
				 CvPackage.Literals.ADDRESS__LINE2,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CvPackage.Literals.ADDRESS__POSTAL_CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CvPackage.Literals.ADDRESS__CITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CvPackage.Literals.ADDRESS__COUNTRY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Address)object).getLine1();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Address.class)) {
			case CvPackage.ADDRESS__LINE1:
			case CvPackage.ADDRESS__LINE2:
			case CvPackage.ADDRESS__POSTAL_CODE:
			case CvPackage.ADDRESS__CITY:
			case CvPackage.ADDRESS__COUNTRY:
